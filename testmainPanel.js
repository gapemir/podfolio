...
class MainWindow extends gn.ui.window.Window {
    ...
    reset() {
        ...
        .then(data => {
            ...
            if(gn.app.App.instance().state == pod.appState.LOGGEDIN){
                this._tileContainer = new PTileContainer();
            }else{
                this._tileContainer = new TileContainer();
            }
...
App.root.add(new LoginWindow());
App.root.registerConstructable("mainWindow", MainWindow);